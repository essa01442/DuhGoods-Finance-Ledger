<template>
  ...
  >
    ...
    <div class="flex-1 overflow-auto p-4 dark:bg-gray-875" dir="rtl">
      <div
        class="mb-4 p-3 rounded border dark:border-gray-700 dark:bg-gray-800"
      >
        <div class="text-sm font-semibold dark:text-gray-200 mb-1">
          {{
            t`القاعدة: لا يُفترض تلقائياً أن أي معاملة خاضعة للضريبة أو معفاة. يُطلب مراجعة بشرية للتصنيف الضريبي غير الواضح.`
          }}
        </div>
      </div>
          ...
          <div class="flex justify-between items-start gap-4">
            ...
            <div class="shrink-0">
              ...
              >
                ...
                <option value="recoverable_vat">
                  {{ t`ضريبة قابلة للاسترداد` }}
                </option>
                <option value="non_recoverable_vat">
                  {{ t`ضريبة غير قابلة للاسترداد` }}
                </option>
